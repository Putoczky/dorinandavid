...
export default function RSVPForm() {
	...
	if (step === 'rsvp') {
		return (
			...
			<h2 className="font-['Cinzel'] text-3xl sm:text-4xl md:text-5xl font-normal text-[#0d0c16] mb-4 text-center">
				Jelezz vissza nekünk
			</h2>
			<p className="font-['Cinzel'] text-lg sm:text-xl md:text-2xl font-normal text-[#0d0c16] mb-8 text-center leading-relaxed">
			A következő vendégeknek a visszajelzését is el tudod küldeni:
				...
				<div className="flex flex-col gap-8 max-w-[800px] mx-auto">
					{familyMembers.map((member) => (
						<div key={member.id} className="border-b-2 border-[#0d0c16] pb-6">
							<div className="flex items-center gap-8 mb-4">
								<span className="font-['Cinzel'] text-lg sm:text-xl text-[#0d0c16] min-w-[200px]">
									{member.name}
								...
								<div className="flex gap-8 flex-1">
									<label className="flex items-center gap-3 cursor-pointer">
										...
										/>
										<span className="font-['Cinzel'] text-lg sm:text-xl text-[#0d0c16]">
											Szertartas
										</span>
									</label>
									<label className="flex items-center gap-3 cursor-pointer">
									...
									<div className="flex items-center gap-3">
										<label className="flex items-center gap-3 cursor-pointer">
											<input
												...
												className="w-5 h-5 cursor-pointer"
											/>
											<span className="font-['Cinzel'] text-base sm:text-lg text-[#0d0c16]">
												Etelerzekenyseg
											</span>
										</label>
										{hasDietaryRestrictions[member.id!] && (
											<input
												...
												className="bg-transparent border-0 border-b-2 border-gray-400 py-2 font-['Cinzel'] text-base sm:text-lg text-[#0d0c16] outline-none flex-1 placeholder:text-gray-500 placeholder:opacity-70 focus:border-gray-400"
											/>
										)}
									</div>
									<label className="flex items-center gap-3 cursor-pointer">
					...
					<div className="flex flex-col gap-2 mt-8">
						<label className="font-['Cinzel'] text-lg sm:text-xl text-[#0d0c16]">
							Email cím <span className="text-red-600">*</span>
						</label>
						<p className="font-['Cinzel'] text-base sm:text-lg text-[#0d0c16] opacity-80 mb-2">
						...
						<input
							...
							className="bg-transparent border-0 border-b-2 border-[#0d0c16] py-3 font-['Cinzel'] text-lg sm:text-xl md:text-2xl text-[#0d0c16] outline-none w-full placeholder:text-gray-500 placeholder:opacity-70 focus:border-[#5a6840]"
						/>
						{emailError && (
					...
					<div className="flex flex-col gap-2 mt-8">
						...
						<textarea
							...
							rows={4}
							className="bg-transparent border-0 border-b-2 border-[#0d0c16] py-3 font-['Cinzel'] text-base sm:text-lg text-[#0d0c16] outline-none w-full placeholder:text-gray-500 placeholder:opacity-70 focus:border-[#5a6840] resize-none"
						/>
					</div>
					...
					<div className="flex gap-4 justify-center relative z-[11]">
						<button
							...
							className="bg-[#5a6840] border-2 border-[#5a6840] text-[#ffffff] py-3 px-8 font-['Cinzel'] text-lg sm:text-xl md:text-2xl cursor-pointer rounded transition-colors hover:bg-[#4a5634] hover:border-[#4a5634]"
						>
							Vissza
						</button>
						<button
							...
							className="bg-[#5a6840] text-[#ffffff] border-0 py-3 px-8 font-['Cinzel'] text-lg sm:text-xl md:text-2xl cursor-pointer rounded transition-colors hover:bg-[#4a5634] active:bg-[#3a4528] disabled:opacity-50 disabled:cursor-not-allowed"
						>
		...
		return (
			<div className="p-8 px-4 pb-32 max-w-[800px] mx-auto relative z-[10]">
				...
				<div className="flex flex-col items-center gap-8 max-w-[500px] mx-auto mt-12">
					<p className="text-[#5a6840] font-['Cinzel'] text-xl sm:text-2xl md:text-3xl text-center">
					...
					<button
						...
						className="bg-[#5a6840] text-[#ffffff] border-0 py-3 px-8 font-['Cinzel'] text-lg sm:text-xl md:text-2xl cursor-pointer rounded transition-colors hover:bg-[#4a5634] active:bg-[#3a4528]"
					>
						Uj visszajelzes
					</button>
				</div>
		...
		<div className="p-8 px-4 pb-32 max-w-[800px] mx-auto relative z-[10]">
			...
			>
				...
				<button
					...
					className="bg-[#5a6840] text-[#ffffff] border-0 py-3 px-8 font-['Cinzel'] text-lg sm:text-xl md:text-2xl cursor-pointer rounded transition-colors self-center hover:bg-[#4a5634] active:bg-[#3a4528] disabled:opacity-50 disabled:cursor-not-allowed"
				>
					{verifyNameMutation.isPending ? 'Keresés...' : 'Visszajelzek'}
				</button>
			</form>
		</div>
	);
